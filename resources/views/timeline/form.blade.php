...
@section('btn-action')
<div class="">
	<a type="button" href="{{ url('timeline') }}" class="btn waves-effect waves-light btn-secondary">Back</a>
</div>
@endsection
...
<div class="row">
	<div class="col-sm-12">
		<div class="card card-body">
			<h4 class="card-title">Form Tambah Timeline</h4>
			<h5 class="card-subtitle"> Input data timeline </h5>
			<form class="form-horizontal mt-4">
				...
				<div class="form-group">
					<label>Timeline / <span class="help"> Kegunaan</span></label>
