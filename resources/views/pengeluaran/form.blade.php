...
@section('btn-action')
<div class="">
	<a type="button" href="{{ url('pengeluaran') }}" class="btn waves-effect waves-light btn-secondary">Back</a>
</div>
@endsection
...
<div class="row">
	<div class="col-sm-12">
		<div class="card card-body">
			...
			<h5 class="card-subtitle"> Input data pengeluaran </h5>
			<form class="form-horizontal mt-4">
				...
				<div class="form-group">
					<label>Pengeluaran / <span class="help"> Kegunaan</span></label>
