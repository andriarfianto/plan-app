...
@section('btn-action')
<div class="">
	<a type="button" href="{{ url('pengeluaran/create') }}" class="btn waves-effect waves-light btn-primary">Tambah</a>
	<a type="button" href="{{ url('pengeluaran') }}" class="btn waves-effect waves-light btn-success">Refresh</a>
</div>
@endsection
