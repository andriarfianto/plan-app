...
@section('btn-action')
<div class="">
	<a type="button" href="{{ url('anggaran') }}" class="btn waves-effect waves-light btn-secondary">Back</a>
</div>
@endsection
...
<div class="row">
	<div class="col-sm-12">
		<div class="card card-body">
			<h4 class="card-title">Form Tambah Rencana Anggaran</h4>
			<h5 class="card-subtitle"> Input data rencana anggaran </h5>
			<form class="form-horizontal mt-4">
				<div class="form-group">
					<label>Produk</label>
					<input type="text" class="form-control" value="Produk">
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<label>Anggaran / <span class="help"> Kegunaan</span></label>
